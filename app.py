"""
============================================================
CODEX ALPHA — INSTITUTIONAL SCOUT PRO V31.0 (Legacy Edition)
...
def _render_screen_nav(screen: str, ticker: str = "") -> None:
    ...
    if screen == "fundamental":
        items += [("🔙 חזור לניתוח וואיקוף", "__wyckoff__"), ("📈 Trading Scout", "📈 Trading Scout")]
    elif screen == "scout":
        items += [("🔙 חזור לוואיקוף", "__wyckoff__"), ("📊 לניתוח פונדמנטלי", "📊 ניתוח פונדמנטלי")]
