"""
============================================================
CODEX ALPHA — INSTITUTIONAL SCOUT PRO V28.0 (Beyond the Noise)
...
def inject_css() -> None:
    ...
    * { scrollbar-width: thin; scrollbar-color: var(--line-strong) var(--bg-0); }
    ...
    /* ===== V28.0 — CODEX ALPHA (landing) ===== */
    .codex-hero { text-align: center; padding: 18px 0 4px; animation: premiumFadeIn 0.5s ease; }
    .codex-title { font-family: 'Cormorant Garamond', serif; font-size: 3.6rem; font-weight: 600;
        letter-spacing: 0.22em; color: #efeae0; margin-right: 0.22em;
        text-shadow: 0 1px 0 rgba(0,0,0,0.85), 0 0 30px rgba(201,162,39,0.10); }
    .codex-tagline { font-family: 'Cormorant Garamond', serif; font-style: italic;
        font-size: 1.08rem; color: #c2a75e; letter-spacing: 0.3em; margin-top: 2px; }
    .codex-divider { width: 140px; height: 1px; margin: 16px auto 10px;
        background: linear-gradient(90deg, transparent, rgba(201,162,39,0.7), transparent); }
    .codex-class { font-size: 0.7rem; letter-spacing: 0.5em; color: #8c6d1f; margin-bottom: 26px; }
    .codex-card { background: linear-gradient(180deg, #111116, #0b0b0f);
        border: 1px solid rgba(201,162,39,0.22); border-radius: 12px;
        padding: 20px 18px 14px; min-height: 176px; margin-bottom: 6px;
        box-shadow: 0 16px 36px rgba(0,0,0,0.55);
        transition: border-color .25s ease, transform .25s ease, box-shadow .25s ease; }
    .codex-card:hover { border-color: rgba(201,162,39,0.55); transform: translateY(-3px);
        box-shadow: 0 22px 46px rgba(0,0,0,0.68); }
    .codex-num { font-family: 'Cormorant Garamond', serif; color: rgba(201,162,39,0.8);
        font-size: 0.82rem; letter-spacing: 0.45em; margin-bottom: 4px; }
    .codex-card .stButton > button { width: 100% !important; background: transparent !important;
        border: none !important; box-shadow: none !important; color: #efeae0 !important;
        font-weight: 800 !important; font-size: 1.3rem !important; line-height: 1.45 !important;
        white-space: pre-line !important; letter-spacing: 0.03em; padding: 6px 0 !important; }
    .codex-card .stButton > button:hover { color: #d9b64a !important; background: transparent !important; }
    .codex-desc { color: #8b93a3; font-size: 0.85rem; line-height: 1.75; min-height: 46px; }
    .codex-mini .stButton > button { background: transparent !important;
        border: 1px solid rgba(201,162,39,0.3) !important; color: #c9b06a !important;
        font-size: 0.8rem !important; padding: 3px 14px !important; border-radius: 8px !important;
        letter-spacing: 0.1em; box-shadow: none !important; }
    .codex-mini .stButton > button:hover { border-color: rgba(201,162,39,0.65) !important;
        color: #e6cc7a !important; }
    .codex-panel { background: #0e0e12; border: 1px solid rgba(201,162,39,0.25);
        border-radius: 12px; padding: 14px 18px 10px; margin: 6px auto 10px; max-width: 620px; }
    @media (max-width: 760px) {
        .codex-title { font-size: 2.2rem; letter-spacing: 0.16em; }
        .codex-card { min-height: 0; }
    }
    </style>
...
def screen_home() -> None:
    ...
    if mode == "landing":
        ...
        for _row in (_cards[:2], _cards[2:]):
            _pad1, _ca, _cb, _pad2 = st.columns([0.5, 2.5, 2.5, 0.5], gap="large")
            for _col, (_num, _label, _key, _mode_to, _is_find, _desc) in zip((_ca, _cb), _row):
                with _col:
